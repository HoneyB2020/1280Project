...
//         var btn = removeCartItemsButton[i];
//         btn.addEventListener('click', removerCartItems)
//     }
// }
// /*/*/
// var quantityInputs = document.getElementsByClassName('cart-quantity-input')
...
// function removerCartItems(event) {
//     var btnClicked = event.target;
//     btnClicked.parentElement.parentElement.remove();
//     //Update cart after clicking
//     UpdateTotal();
// }

// function quantityChanged(event) {
//     var input = event.target;
//     //is this is a number and is this below zero
//     if (isNaN(input.value) || input.value <= 0) {
//         input.value = 1
//     }
//     UpdateTotal();
...
//     ///this will get an array of items - select the first one
//     var cartItemContainer = document.getElementsByClassName('cart-items')[0];
//     var cartRows = cartItemContainer.getElementsByClassName('cart-row');
...
//     for (var i = 0; i < cartRows.length; i++) {
//         var cartRow = cartRows[i];
//         var priceTag = cartRow.getElementsByClassName('cart-price')[0];
//         var quantityNumber = cartRow.getElementsByClassName('cart-quantity-input')[0];
//         //parse price and remove dollar sign
